...
<p>You can view some of my work below or on my <a href="https://github.com/MattJBorowski1991">GitHub</a>.</p>
  ...
  <blockquote>
    <p><em>Machine Learning is evolving so rapidly in recent years that it was tough to decide where to focus. I started learning CUDA in November 2025 and have since profiled and optimized 30+ kernels for ML workloads — including a ~30% speedup in Flash MHA. That focus drives the projects you’ll find below.</em></p>
  </blockquote>
