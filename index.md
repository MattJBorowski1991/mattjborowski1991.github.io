...
<p>Hello visitor! Thanks for your interest.</p>
...
<p>Other than <strong>CUDA</strong> I have experience in machine learning as well as hyperscale data centers.</p>
...
<p>
  ...
  <span class="social-list" style="margin-left:.5rem;">
    ...
    <!-- feed icon removed (no atom.xml present) -->
  </span>
</p>
